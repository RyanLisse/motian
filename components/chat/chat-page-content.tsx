...
const GENERAL_STARTER_PROMPTS: ChatSuggestion[] = [
  ...
  {
    icon: Users,
    label: "Voeg kandidaat toe",
    description: "Maak een nieuw kandidaatprofiel aan in de database.",
    prompt: "Voeg een nieuwe kandidaat toe met naam, skills en beschikbaarheid.",
    toneClassName: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
  },
  {
    icon: Upload,
    label: "Upload CV en match automatisch",
  ...
  {
    icon: GitBranch,
    label: "Toon pipeline overzicht",
    description: "Bekijk de huidige status van alle actieve sollicitaties en matches.",
    prompt:
      "Geef een overzicht van de huidige recruitment pipeline met alle actieve sollicitaties.",
    toneClassName: "bg-violet-500/10 text-violet-600 dark:text-violet-400",
  },
  {
    icon: Settings2,
    label: "Plan interview",
    description: "Plan een screening call of interview voor een kandidaat.",
    prompt: "Plan een interview voor de volgende beschikbare kandidaat in de pipeline.",
    toneClassName: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400",
  },
  {
    icon: Database,
    label: "Start scraper",
    description: "Activeer een scraper om nieuwe vacatures op te halen van een platform.",
    prompt: "Start de scraper voor LinkedIn en haal de laatste vacatures op.",
    toneClassName: "bg-orange-500/10 text-orange-600 dark:text-orange-400",
  },
  {
    icon: FileText,
    label: "Toon GDPR retentie status",
    description: "Bekijk welke kandidaatdata het retentiebeleid heeft bereikt.",
    prompt: "Toon de GDPR retentiestatus en welke kandidaten verwijderd moeten worden.",
    toneClassName: "bg-slate-500/10 text-slate-600 dark:text-slate-400",
  },
];
