...
import { importJobsFromAts, reviewGdprRequests, runCandidateScoring } from "./motian-actions";
...
function App() {
  ...
  const [statusTitle, setStatusTitle] = useState("OpenTUI Motian Console");
  ...
  return (
    <box flexDirection="column" gap={1} paddingX={2} paddingY={1} flexGrow={1}>
      <text attributes={TextAttributes.BOLD}>Motian Operations TUI (React)</text>
