...
/**
 * Explicit column select — only the columns the list page actually renders.
 * This avoids pulling heavy columns (embedding, resumeRaw) and insulates
 * against schema drift (new columns added to schema.ts but not yet migrated).
 */
const LIST_COLUMNS = {
  id: candidates.id,
