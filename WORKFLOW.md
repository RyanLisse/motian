...
tracker:
  kind: linear
  project_slug: "motian-0ed97889acb8"
  active_states:
    - Todo
    - In Progress
    - Merging
...
agent:
  ...
  max_turns: 20
codex:
  command: /Users/cortex-air/.bun/bin/codex --config shell_environment_policy.inherit=all --config model_reasoning_effort=xhigh --model gpt-5.3-codex app-server
...
- `launch-app`: launch the Next.js dev server for runtime validation.
